...
class OrganizationIdentityKey(Base):
    __tablename__ = "organization_identity_keys"
    __table_args__ = (
        CheckConstraint(
    ...
    organization_identity_id: Mapped[UUID] = mapped_column(
    ...
    organization_identity: Mapped["OrganizationIdentity"] = relationship(back_populates="keys")